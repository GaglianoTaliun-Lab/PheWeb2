    ...
    <v-app>
        ...
        <v-main>
            ...
            <v-navigation-drawer v-model="drawer" app :width="200" align="left" location="left"> 
                ...
                <v-list-item link variant="plain" @click="selectContent('ContinuousPhenotype')" title="4.1 Continuous Phenotypes"></v-list-item>
                <v-list-item link variant="plain" @click="selectContent('BinaryPhenotype')" title="4.2 Binary Phenotypes"></v-list-item>
            ...
            <div  align="left" style="padding: 2%;">
                ...
                <div v-if="selectedContent === 'AncestryEuro'" id='AncestryEuro'>
                    ...
                    <v-card id="top-pca-card" class="pa-4">
                ...
                <div v-if="selectedContent === 'ContinuousPhenotype'" id="ContinuousPhenotype">
                    <h2>4.1 Continuous Phenotypes</h2>
                    <hr></hr>
                ...
                <div v-if="selectedContent === 'BinaryPhenotype'" id="BinaryPhenotype">
                    <h2>4.2 Binary Phenotypes</h2>
                    <hr></hr>
                    <p>The criteria for selecting binary phenotypes for association analysis are as follows (see <b>Figure 1</b>):</p>
                    ...
                    <v-card class="pa-4">
                        <span>
                            <b>Figure 1</b>. Flow chart of filtering criteria for binary variables.
                        </span>
                        <br>
                        <img src="@/assets/Binary_Diagram.canvas.png" alt="Figure 1 - Binary Diagram" class="img-fluid mt-3" />
                    </v-card>
                </div>
                ...
                <div v-if="selectedContent === 'Regenie'" id="Regenie">
                    ...
                    <li>Sex covariate is defined as '1' for males and '2' for females individuals.</li>
