...
<template>
    <div style="position: relative">
        <div v-if="isLoading" class="lz-loading-overlay">
            <span class="spinner"></span> Loading LocusZoom...
        </div>
        <div :id="sanitizeId(props.stratification)" :style="{ visibility: isLoading ? 'hidden' : 'visible' }"></div>
    </div>
</template>
